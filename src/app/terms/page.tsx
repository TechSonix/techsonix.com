    ...
    content: (
      <>
        ...
        <p>
          ...
          and the <a href="/community/">community rules</a>. Do not use the
          services to exploit children, distribute unlawful intimate material,
          threaten or harass others, commit fraud, distribute malware, infringe
          rights, or interfere with the security of other systems.
        </p>
        <p>
    ...
    content: (
      <>
        ...
        <p>
          ...
          <a href="/community/#report">private reporting channel</a>; identify
          the content without sending copies of illegal material.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Contact <a href="/support/">TechSonix, Inc.</a> for questions,
          complaints, or a request to review a decision. See the{" "}
          <a href="/privacy/">privacy policy</a> for data handling and the{" "}
          <a href="/delete-data/">deletion page</a> for removal requests.
        </p>
      </>
    ),
  },

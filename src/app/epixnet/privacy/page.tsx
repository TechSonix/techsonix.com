...
export const metadata = {
  ...
  alternates: { canonical: "/epixnet/privacy/" },
};
const sections: PolicySection[] = [
    ...
    content: (
      <>
        <p>
          ...
          <a href="/epixnet/support/#contact">support form</a> and select
          “Privacy request.”
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Use our <a href="/epixnet/delete-data/">data-deletion page</a> to
          request removal of personal data controlled by TechSonix. You can also
          contact us to request access, correction, a copy of information, or
          other privacy rights available under the law that applies to you. You
          may have rights to object to or restrict processing and to complain to
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        Contact <a href="/epixnet/support/#contact">TechSonix support</a> with
